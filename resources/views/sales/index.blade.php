    ...
    <div class="col-10">
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
                ...
                @if(in_array(Auth::user()->role, [\App\Enums\Role::SUPER_ADMIN, \App\Enums\Role::SALES]))
                <a href="{{ route('sales.form') }}" class="btn btn-primary btn-sm" id="add-button">
    ...
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="detail-modal_title">Sale Detail</h5>
